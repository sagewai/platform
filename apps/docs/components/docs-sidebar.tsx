...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'LiteLLM Integration', href: '/docs/guides/litellm-integration' },
      { label: 'Cost Management', href: '/docs/guides/cost-management' },
      { label: 'PII Protection', href: '/docs/guides/pii-protection' },
      { label: 'Sandboxing', href: '/docs/guides/sandboxing' },
      { label: 'Sealed Vault', href: '/docs/guides/sealed-vault' },
