...
export const metadata = {
  ...
  description:
    'State the goal in plain English. Autopilot designs the agent graph, extracts slots, schedules a mission, and drives execution. Failure handling and automatic healing are on the roadmap.',
...
- **See recommended actions when a step fails** — today the controller reports a failed mission and the healing engine surfaces recommended actions. Acting on them automatically (detect, isolate, retry) is on the roadmap.
