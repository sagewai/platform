...
The identity, secret-backend, and audit foundations apply whether you're calling an LLM from the SDK or scaling out a Fleet. This page walks a security reviewer, CISO, or compliance lead through each layer — what it protects, what ships versus what is maturing, how to enable it, and where to read the configuration details.
