export const metadata = {
  title: 'Agent patterns — reusable orchestration recipes',
  description:
    'Reference guide to Sagewai\'s core orchestration patterns. Pick the one that matches your task structure: sequential, parallel, conditional, iterative.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/tutorials/production-patterns' },
};
