export const metadata = {
  title: 'Hardware requirements — Sagewai laptop to cluster',
  description:
    'System requirements for every Sagewai deployment: laptop dev, single-node prod, multi-node Kubernetes, GPU workers. CPU, RAM, disk, network sizing.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/guides/hardware-requirements' },
};
