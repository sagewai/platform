export const metadata = {
  title: 'Infrastructure management — Sagewai container lifecycle',
  description:
    'Start, stop, monitor, maintain Sagewai infrastructure. Docker, Podman alternative, native setup, data management, backup, and recovery.',
