...
|---------|-------------|--------------|
| PostgreSQL | `sagecurator_postgres_data` | Workflows, runs, workers, audit logs |
| Milvus | `sagecurator_milvus_data` | Vector embeddings |
| MinIO | `sagecurator_minio_data` | Milvus object storage |
| etcd | `sagecurator_etcd_data` | Milvus metadata |
| NebulaGraph | `sagecurator_nebula_*` | Graph data and metadata |
