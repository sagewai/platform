export const metadata = {
  title: 'Sagewai tutorials — hands-on, copy-paste-runnable',
  description:
    'Step-by-step tutorials to get productive with Sagewai. Each tutorial is self-contained with complete, copy-paste code. Zero to production deployment.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/guides/tutorials' },
};
