export const metadata = {
  title: 'Fleet deployment — distributed Sagewai workers',
  description:
    'Run Sagewai workflow workers on your own infrastructure. Cloud orchestration, on-prem GPUs, edge devices. Hybrid deployment with hard project isolation.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/guides/fleet' },
};
