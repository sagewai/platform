...
- **LLM proxy virtual key** — assign a virtual API key scoped to this project for spend tracking and rate limiting
...
- **LLM Proxy** — proxy URL and masked API key with a "Test Connection" button to verify connectivity
