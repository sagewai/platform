export const metadata = {
  ...
  description:
    'Run LLMs locally with Sagewai: zero API cost, your data stays in your network. Ollama, vLLM, LM Studio, and llama.cpp all supported.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/guides/local-inference' },
};

# Local Inference & LLM Providers

Sagewai supports 100+ LLM models and providers. Use cloud APIs, managed inference services, or run models locally with zero API costs.
