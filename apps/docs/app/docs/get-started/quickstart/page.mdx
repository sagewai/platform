...
The admin server is part of the base install — no extra needed. The
`postgres` extra adds durable workflow storage; SQLite works for local
exploration but production should use Postgres.
