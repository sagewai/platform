export const metadata = {
  title: 'Safety & Guardrails API — agent input/output validation',
  description:
    'Sagewai guardrails API: PII detection, hallucination guards, content filters, schema validators, token budgets. Composable, attach-anywhere safety.',
  alternates: { canonical: 'https://docs.sagewai.ai/docs/api-reference/safety' },
};
