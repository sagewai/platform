...
This is **Tier 4** of the [example catalogue](/docs/tutorials) — reference-grade examples for harder problems. Each is 200-400 lines but lacks the audience-pin storytelling of a [Tier 5 lighthouse](/docs/tutorials). Goal: *"here's a complete-ish solution to a non-trivial problem."*

These examples are organised by pillar. They're the pages you reach when you've outgrown a [foundation](/docs/tutorials/learn-the-sdk) example and you're not yet ready to read the lighthouse work.
...
## Orchestration pattern recipes

These patterns solve distinct orchestration challenges. Pick the one that matches your task structure.
...
- **[End-to-end examples](/docs/tutorials)** — the production-grade compositions that build on these patterns.
- **[Foundation](/docs/tutorials/learn-the-sdk)** — the shorter SDK basics that precede these patterns.
