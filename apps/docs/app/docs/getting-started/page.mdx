...
export const metadata = {
  ...
  alternates: { canonical: 'https://docs.sagewai.ai/docs/getting-started' },
  openGraph: {
    ...
    url: 'https://docs.sagewai.ai/docs/getting-started',
  },
};
  ...
  steps={[
    {
      ...
      text: 'pip install sagewai[fastapi] then run sagewai admin serve to start the local control plane on http://localhost:8000.',
    },
    {
    ...
    },
    {
      ...
      text: 'Run sagewai run portfolio-site. The worker dispatches Claude Code inside an isolated sandbox; credentials inject from Sealed; the result is committed back to GitHub.',
    },
  ]}
/>
