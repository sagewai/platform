export const metadata = {
  ...
  alternates: { canonical: 'https://docs.sagewai.ai/docs/getting-started/minimal-setup' },
};
...
portfolio site — go to the [Quickstart](/docs/getting-started)
instead.
...
- See [Hardware Requirements](/docs/guides/hardware-requirements) for detailed system specs
...
- **[Tutorials](/docs/guides/tutorials)** — 8 progressive hands-on tutorials from first agent to enterprise deployment
- **[Video Tutorials](/docs/guides/video-tutorials)** — 20 video walkthroughs covering every feature
- **[Your First Agent](/docs/guides/first-agent)** — Step-by-step tutorial building a real-world research agent
...
- **[Quickstart](/docs/getting-started)** — Mode 3 end-to-end walk-through (build a portfolio site with Claude Code).
...
- **[Fleet Architecture](/docs/guides/fleet-enterprise)** — server + worker topology with multi-tenant isolation.
- **[Hardware Requirements](/docs/guides/hardware-requirements)** — system specs for every deployment scenario.
