...
This page is the decision guide for picking the sandbox backend that runs your Sagewai workers' isolation containers. If you're deploying Sagewai and need to choose between Docker, Kubernetes, or Lambda — or work out whether a heterogeneous fleet makes sense — start here.
...
|---|---|---|---|---|---|
| Null | bare mode only — no actual sandbox | bare | n/a | n/a | shipped |
