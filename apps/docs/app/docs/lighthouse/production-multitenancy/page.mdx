...
- **Primary product:** [Fleet](/docs/pillars/fleet) — workers, dispatch, scoped routing.
- **Security model:** [Security overview](/docs/security) — the cross-cutting credential, redaction, replay, and audit story.
...
- **Sibling lighthouse:** [Moderation and classification](/docs/lighthouse/moderation-and-classification) — the same boundary applied to a different workload.
