...
- **Primary pillar:** [SDK](/docs/pillars/sdk) — the substrate this lighthouse exercises.
- **Sibling lighthouse:** [Train your own model](/docs/lighthouse/train-your-own-model) — pairs naturally with semantic-checkpoint recall (cheap LLM plus smart retrieval).
