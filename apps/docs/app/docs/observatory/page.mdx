...
export const metadata = {
  ...
  alternates: { canonical: 'https://docs.sagewai.ai/docs/observatory' },
  openGraph: {
    ...
    url: 'https://docs.sagewai.ai/docs/observatory',
...
- [Fleet enterprise architecture](/docs/guides/fleet-enterprise) — Fleet pillar lighthouse. The multi-tenant story the dashboards are scoped to.
