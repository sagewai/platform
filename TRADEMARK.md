...
- Use the Sagewai name to accurately describe your use of the software (e.g., "Built with Sagewai", "Powered by Sagewai", "Compatible with Sagewai")
- Use the Sagewai name in blog posts, talks, and educational materials about the software
- Use the Sagewai logo in presentations and articles about Sagewai, with proper attribution
- Fork the project for personal or internal use while retaining the Sagewai name (as AGPL-3.0 requires attribution)
...
**Example of what is NOT allowed**: Taking Sagewai and offering it as "CloudAgent Platform" or "AWS SageOrchestrator" without a white-label license.

**Example of what IS allowed**: Offering "Acme AI Platform, powered by Sagewai" with visible Sagewai attribution.
...
This policy is inspired by the trademark policies of Mozilla, Docker, and Grafana Labs.
