...
_ALLOWED: dict[TaskStatus, frozenset[TaskStatus]] = {
    S.PLANNING: frozenset({
        S.CLARIFYING, S.PLAN_PROPOSED, S.EXECUTING, S.BLOCKED, S.BUDGET_EXHAUSTED,
        S.CONTROL_DEGRADED, S.PAUSED, S.CANCELLED,
    }),
    ...
    S.ASSESSING: frozenset({
        S.COMPLETE, S.SCHEDULED, S.PLANNING, S.BLOCKED, S.BUDGET_EXHAUSTED,
        S.CONTROL_DEGRADED, S.PAUSED, S.CANCELLED,
    }),
