...
_ALLOWED: dict[TaskStatus, frozenset[TaskStatus]] = {
    ...
    S.ASSESSING: frozenset({S.COMPLETE, S.SCHEDULED, S.PLANNING, S.BLOCKED, S.BUDGET_EXHAUSTED, S.CANCELLED}),
    S.SCHEDULED: frozenset({S.EXECUTING, S.PLANNING, S.PAUSED, S.CANCELLED}),
    S.PAUSED: frozenset({S.PLANNING, S.CLARIFYING, S.PLAN_PROPOSED, S.EXECUTING, S.SCHEDULED, S.CANCELLED}),
    S.BLOCKED: frozenset({S.PLANNING, S.EXECUTING, S.CANCELLED}),
    S.BUDGET_EXHAUSTED: frozenset({S.PLANNING, S.EXECUTING, S.CANCELLED}),
    S.CONTROL_DEGRADED: frozenset({S.EXECUTING, S.BLOCKED, S.CANCELLED}),
