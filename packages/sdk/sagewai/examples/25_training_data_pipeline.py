...
async def main() -> None:
    ...
    print()
    print("  # In admin panel: /connections → + Add Connection")
    print("  #   Protocol: Inference provider")
    print("  #   provider_key: ollama, model_name: healthcare-assistant")
    print("  # Or via CLI:")
    print("  #   sagewai connections add inference \\")
    print("  #     --provider-key ollama --model healthcare-assistant")
    print("  # Then set as project default:")
    print("  #   sagewai connections set-default <connection-id>")
    print()
